...
//   const [token, setToken] = useState(null);
//   const [id, setId] = useState(null);
//   const [userType, setUserType] = useState(null); // Will be detected automatically
//   const [isValidLink, setIsValidLink] = useState(true);
//   const [isVerifying, setIsVerifying] = useState(true);
...
//   // In ResetPassword.jsx, update the useEffect to handle the new parameters:
// useEffect(() => {
//   const tokenParam = searchParams.get("token");
//   const idParam = searchParams.get("id");
//   const userTypeParam = searchParams.get("user_type"); // FIXED: Changed from 'type' to 'user_type'
...
//   setToken(tokenParam);
//   setId(idParam);
//   setUserType(userTypeParam || 'user'); // Default to 'user' if not specified
  
//   // Now verify the token
//   const verifyToken = async () => {
//     try {
//       // Use the check-reset-token endpoint
...
//         // Use the user_type from the response
...
//   //   setIsResetting(true);
//   //   try {
//   //     // Use the unified reset password endpoint
...
//   //     const userTypeName = userType === 'houseowner' ? 'House Owner' : 'User';
//   //     toast.info(`You can now login with your new password as a ${userTypeName}.`, {
//   //       autoClose: 4000
//   //     });
...
//   // In ResetPassword.jsx, update the handleSubmit function:
// const handleSubmit = async (e) => {
//   e.preventDefault();
...
//             <h1 className="font-bold text-2xl text-center">Set New Password</h1>
...
//             {/* Password Requirements */}
//             <div className="mb-5 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
...
//             <button 
//               type="submit" 
//               className="loginButton loginButton--submit w-full flex items-center justify-center py-3 text-lg"
//               disabled={isResetting || !Object.values(validations).every(v => v === true)}
//             >
//               {isResetting ? (
//                 <>
