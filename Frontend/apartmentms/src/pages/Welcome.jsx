  ...
  return (
    <div className="welcomePage">
      ...
      <div className="absolute top-4 right-2 sm:right-6 flex gap-2 sm:gap-4 md:gap-6 mt-5">
        <button 
          onClick={() => navigate("/login")} 
          className="px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-2 text-sm sm:text-base font-medium text-white bg-transparent border border-white/50 rounded-lg hover:bg-white/10 transition-all duration-200 shadow-sm"
        >
          Sign In
        </button>
        <button 
          onClick={() => navigate("/register")} 
          className="px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-2 text-sm sm:text-base font-medium text-white bg-purple-600 border border-purple-600 rounded-lg hover:bg-purple-700 transition-all duration-200 shadow-sm"
        >
          Sign Up
        </button>
      </div>
