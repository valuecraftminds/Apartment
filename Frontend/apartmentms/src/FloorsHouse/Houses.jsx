...
import { Building, ChevronLeft, Edit, Image, Loader, Plus, Trash2 } from 'lucide-react'
    ...
    useEffect(() => {
        const fetchFloor = async () => {
            try {
                ...
                if (res.data.success) {
                    setFloor(res.data.data); // set the apartment object
                }
            } catch (err) {
                                ...
                                <table className="w-full table-auto">
                                    <thead className="bg-gray-50 dark:bg-gray-700">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Status</th>                                                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Occupied way</th>
