...
import { Building, Building2, ChevronLeft, Image, Loader, Plus, Trash2 } from 'lucide-react';
...
export default function Floors() {
    ...
    try {
        ...
        const result = await api.get(`/floors?apartment_id=${id}`); // ✅ pass apartment id
                    ...
                    <div className='flex items-center justify-between bg-white dark:bg-gray-800 rounded-2xl p-4 mb-6'>
                        <div className='flex flex-col'>
                            <div className='flex items-center'>
                                ...
                                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Floors & Houses</h1>
                            </div>
