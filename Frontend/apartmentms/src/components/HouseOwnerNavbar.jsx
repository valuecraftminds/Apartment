...
// import { Menu, X, Bell, Search, LogOut, Moon, Sun, Home, Settings } from 'lucide-react'
...
//             {/* Settings */}
//             <button className="p-2 rounded-full text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
//               <Settings size={20} />
//             </button>
