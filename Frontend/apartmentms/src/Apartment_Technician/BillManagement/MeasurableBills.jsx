...
//                                                 <button className='px-2 py-1 mt-3 rounded-lg font-semibold shadow-md transition-all duration-300 text-white bg-purple-600 hover:bg-purple-700 hover:scale-105'>Calculate</button>
//                                             </div>
//                                         </div>
//                                     ))}
//                                 </div>
