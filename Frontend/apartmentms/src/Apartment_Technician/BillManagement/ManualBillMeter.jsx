...
//         if ((name === 'meterReading' || name === 'previousReading') && 
//             updatedForm.meterReading && updatedForm.previousReading) {
//             const current = parseFloat(updatedForm.meterReading);
//             const previous = parseFloat(updatedForm.previousReading);
//             if (!isNaN(current) && !isNaN(previous) && current >= previous) {
//                 updatedForm.consumption = (current - previous).toFixed(2);
//             }
//         }
...
//     const handleCalculateBill = (house) => {
//         if (!house || !userAssignedBill) {
...
//             house: {
//                 houseId: house.id,
//                 house_name: house.house_id, // Use actual house ID field
...
//                                                                         <button
//                                                                             type="button"
//                                                                             // onClick={onClose} // If you want to go back
//                                                                             className="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
//                                                                         >
//                                                                             Cancel
//                                                                         </button>
//                                                                         <button
//                                                                             onClick={() => handleCalculateBill(selectedHouse)}
//                                                                             disabled={!selectedHouse || !formData.meterReading}
//                                                                             className="px-8 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
//                                                                         >
