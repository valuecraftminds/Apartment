...
export default function EditUser({ user, onClose, onUpdated, roles, rolesLoading }) {
  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        mobile: user.mobile || '',
        role_id: user.role_id || '', // Use role_id instead of role
        password: '',
        confirmPassword: ''
      });
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition-colors disabled:bg-purple-400 disabled:cursor-not-allowed flex items-center"
              >
                {loading ? (
                  <>
