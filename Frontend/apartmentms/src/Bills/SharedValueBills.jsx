...
export default function SharedValueBills() {
    ...
    // Filter bills - Only show Shared bills in this component
    const sharedValueBills = bills.filter(bill => bill.billtype === 'Shared');
    ...
    // Navigate to shared value bill prices page
    const handleRowClick = (bill) => {
        navigate(`/shared-value-bill-prices/${bill.id}`);
    };
        ...
        <div>
            {loadingBills ? (
                <div className="flex justify-center items-center py-12">
                    ...
                    <span className="ml-2 text-gray-600 dark:text-gray-300">Loading Shared Value Bill types...</span>
                </div>
            ) : error ? (
            ...
            ) : sharedValueBills.length === 0 ? (
                <div className="text-center py-12 text-gray-600 dark:text-gray-300">
                    <Image size={48} className="mx-auto mb-4 text-gray-400" />
                    <p className="text-lg">No shared value bill types found</p>
                    <p className="text-sm">Get started by adding shared value bill types</p>
                </div>
            ) : (
