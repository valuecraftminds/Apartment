...
//                 bg-white dark:bg-gray-800 rounded-2xl p-6 mb-6'> */}
...
//                                 className='flex items-center gap-2 px-4 py-2 ml-170 rounded-lg font-semibold shadow-md transition-all duration-300 text-white bg-purple-600 hover:bg-purple-700 hover:scale-105'>
//                                 <Plus size={20} />
            ...
            if (floorId && !floorMap[floorId]) {
                try {
                    ...
                    if (floorResponse.data.success) {
                        setFloorMap(prev => ({
                            ...prev,
                            [floorId]: floorResponse.data.data.name
                        }));
                    }
                } catch (error) {
            ...
            if (houseId && !houseMap[houseId]) {
                try {
                    ...
                    if (houseResponse.data.success) {
                        setHouseMap(prev => ({
                            ...prev,
                            [houseId]: houseResponse.data.data.name
                        }));
                    }
                } catch (error) {
